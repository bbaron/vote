...
privileged aspect VoteIntegrationTest_Roo_IntegrationTest {
    ...
    public void VoteIntegrationTest.testCountVotes() {
        ...
        long count = com.springsource.vote.domain.Vote.countVotes();
    ...
    public void VoteIntegrationTest.testFindVote() {
        com.springsource.vote.domain.Vote obj = dod.getRandomVote();
        ...
        obj = com.springsource.vote.domain.Vote.findVote(id);
    ...
    public void VoteIntegrationTest.testFindAllVotes() {
        ...
        java.util.List<com.springsource.vote.domain.Vote> result = com.springsource.vote.domain.Vote.findAllVotes();
    ...
    public void VoteIntegrationTest.testFindVoteEntries() {
        ...
        java.util.List<com.springsource.vote.domain.Vote> result = com.springsource.vote.domain.Vote.findVoteEntries(0, (int) count);
    ...
    public void VoteIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyVote(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.springsource.vote.domain.Vote merged = (com.springsource.vote.domain.Vote) obj.merge();
        obj.flush();
    ...
    public void VoteIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Vote' failed to initialize correctly", dod.getRandomVote());
        com.springsource.vote.domain.Vote obj = dod.getNewTransientVote(Integer.MAX_VALUE);
    ...
    public void VoteIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Vote' with identifier '" + id + "'", com.springsource.vote.domain.Vote.findVote(id));
    }
